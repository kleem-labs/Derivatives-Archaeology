...
Probability is often introduced as a bag of formulas. Here it arrives because the binomial tree's branches have become too numerous to list. The reader must learn what is random, what carries probability, and why pricing weights are not forecasts.

- [012 — Random Variables](../excavations/012-random-variables/README.md)
- [013 — Expectation and Variance](../excavations/013-expectation-and-variance/README.md)
- [014 — Normal and Lognormal Models](../excavations/014-normal-and-lognormal/README.md)
- [015 — Brownian Motion](../excavations/015-brownian-motion/README.md)
- [016 — Quadratic Variation](../excavations/016-quadratic-variation/README.md)
- [017 — Itô's Lemma](../excavations/017-itos-lemma/README.md)
- [018 — Change of Measure](../excavations/018-change-of-measure/README.md)
- [019 — Martingales and Numeraires](../excavations/019-martingales-and-numeraires/README.md)

## Coda — The same paths under a different light
